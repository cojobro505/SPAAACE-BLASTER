...
class Bullet(Sprite):
	...
	def __init__(self,ai_game):
		...
		# self.ship = self.ai_game.ship use the with the moving 
		# booleans to create horizontally moving bullets

		# self.bullet_direction_l = self.ship.moving_left or something
